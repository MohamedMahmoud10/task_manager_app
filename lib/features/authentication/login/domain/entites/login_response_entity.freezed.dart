...
class _$LoginResponseEntityImpl implements _LoginResponseEntity {
  ...
  @override
  String toString() {
    return 'LoginResponseEntity(id: $id, userName: $userName, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, token: $token, refreshToken: $refreshToken)';
  }
...
abstract class _LoginResponseEntity implements LoginResponseEntity {
  const factory _LoginResponseEntity(
      ...
      required final String refreshToken}) = _$LoginResponseEntityImpl;
